...
env = PulseEnv('./traces/trace.log', source_id=3, obs_ord=3, max_steps=10000, num_gaps=64)
...
model.learn(total_timesteps=1_000_000, log_interval=100, progress_bar=True)
